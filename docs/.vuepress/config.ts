...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'SHRaymondJ', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'RaymondJ', // 必需
      link: 'https://github.com/SHRaymondJ', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://avatars.githubusercontent.com/u/15604004?s…00&u=0c45ee36ed51413a42e5c284f932a4bb67b0037f&v=4',
      name: 'Raymond Jiang',
      slogan: '初出茅庐的前端',
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:raymondjzd@gmail.com',
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/SHRaymondJ',
        },
      ],
    },
